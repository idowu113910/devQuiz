    ...
    >
      ...
      <div className="flex justify-center md:justify-center lg:justify-end lg:-mx-5">
        <button
          ...
          className="rounded-[12px] ml-4 md:rounded-[24px] md:mr-64 lg:mr-8 shadow-[0_4px_10px_rgba(143,160,193,0.14)] bg-[#A729F5] text-white p-[12px] md:p-[32px] w-[327px] md:w-[640px] lg:w-[564px] text-[18px] md:text-[28px] font-medium h-[56px] md:h-[92px]"
        >
          Play Again
        </button>
      </div>
